...
namespace UserHandler{
    ...
    boost::asio::awaitable<void> logoutUser(HttpRequest &&request, HttpResponse &response,const RequestParams &requestParams);
    boost::asio::awaitable<void> getUserByUUID(HttpRequest &&request, HttpResponse &response,const RequestParams &requestParams);
    boost::asio::awaitable<void> getCurrentUser(HttpRequest &&request, HttpResponse &response,const RequestParams &requestParams);
